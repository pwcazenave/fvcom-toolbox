function Mobj = get_HYCOM_tsobc(Mobj, hycom)
...
%             variables of temperature and salinity (called 'temperature'
%             and 'salinity') exist. Their shape should be (y, x, sigma,
%             time).
...
[~, ~, nz, nt] = size(hycom.temperature.data);
...
for t = 1:nt
    ...
    pctemp3 = hycom.temperature.data(:, :, :, t);
    pcsalt3 = hycom.salinity.data(:, :, :, t);
    ...
    for j = 1:nz
        ...
        pctemp2 = pctemp3(:, :, j)';
        pcsalt2 = pcsalt3(:, :, j)';
        pcdepth2 = squeeze(hycom.Depth.data(:, :, j, t))';
